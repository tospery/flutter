  ...
  Widget _buildTextField(BuildContext context) {
    return TextField(
      decoration: InputDecoration(
        ...
        border: newOutlineBorder(width: 0, radius: 0, context: context),
        enabledBorder: newOutlineBorder(width: 0, radius: 0, context: context),
        focusedBorder: newOutlineBorder(width: 0, radius: 0, context: context),
    ...
    return Container(
      ...
      child: TextField(
        decoration: InputDecoration(
          ...
          enabledBorder: newOutlineBorder(width: 0, radius: 0, context: context),
          focusedBorder: newOutlineBorder(width: 0, radius: 0, context: context),
          disabledBorder: newOutlineBorder(width: 0, radius: 0, context: context),
          errorBorder: newOutlineBorder(width: 0, radius: 0, context: context),
          focusedErrorBorder: newOutlineBorder(width: 0, radius: 0, context: context),
        ),
        maxLines: 7,
        minLines: 5,
        maxLength: 160,
